...
#define AFL_SNAPSHOT_EXCLUDE_VMRANGE \
  _IOW(AFL_SNAPSHOT_IOCTL_MAGIC, 3, struct afl_snapshot_vmrange_args *)
#define AFL_SNAPSHOT_INCLUDE_VMRANGE \
  _IOW(AFL_SNAPSHOT_IOCTL_MAGIC, 4, struct afl_snapshot_vmrange_args *)
#define AFL_SNAPSHOT_IOCTL_TAKE _IOW(AFL_SNAPSHOT_IOCTL_MAGIC, 5, int)
